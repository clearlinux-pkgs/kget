...
Source0  : https://download.kde.org/stable/release-service/24.05.1/src/kget-24.05.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.1/src/kget-24.05.1.tar.xz.sig
...
%setup -q -n kget-24.05.1
cd %{_builddir}/kget-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718564743
mkdir -p clr-build
pushd clr-build
