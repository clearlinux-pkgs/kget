...
Version  : 19.08.2
Release  : 13
URL      : https://download.kde.org/stable/applications/19.08.2/src/kget-19.08.2.tar.xz
Source0  : https://download.kde.org/stable/applications/19.08.2/src/kget-19.08.2.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.2/src/kget-19.08.2.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570743316
mkdir -p clr-build
pushd clr-build
