...
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/kget-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/kget-24.08.0.tar.xz.sig
...
%setup -q -n kget-24.08.0
cd %{_builddir}/kget-24.08.0
pushd ..
cp -a kget-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724704564
mkdir -p clr-build
pushd clr-build
