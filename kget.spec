...
Version  : 18.08.0
Release  : 1
URL      : https://download.kde.org/stable/applications/18.08.0/src/kget-18.08.0.tar.xz
Source0  : https://download.kde.org/stable/applications/18.08.0/src/kget-18.08.0.tar.xz
...
Requires: kget-lib
Requires: kget-data
Requires: kget-license
Requires: kget-locales
...
export LANG=C
export SOURCE_DATE_EPOCH=1535197647
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
export SOURCE_DATE_EPOCH=1535197647
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/kget
cp COPYING %{buildroot}/usr/share/doc/kget/COPYING
cp COPYING.DOC %{buildroot}/usr/share/doc/kget/COPYING.DOC
cp COPYING.LIB %{buildroot}/usr/share/doc/kget/COPYING.LIB
cp cmake/modules/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/doc/kget/cmake_modules_COPYING-CMAKE-SCRIPTS
pushd clr-build
%make_install
popd
%find_lang kget
...
/usr/share/doc/HTML/ca/kget/kget_Network.png
/usr/share/doc/HTML/ca/kget/kget_Web_Interface.png
/usr/share/doc/HTML/ca/kget/kget_drop_target.png
/usr/share/doc/HTML/ca/kget/kget_groups.png
/usr/share/doc/HTML/ca/kget/kget_verification.png
/usr/share/doc/HTML/ca/kget/metalink0.png
/usr/share/doc/HTML/ca/kget/metalink1.png
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/kget/COPYING
/usr/share/doc/kget/COPYING.DOC
/usr/share/doc/kget/COPYING.LIB
/usr/share/doc/kget/cmake_modules_COPYING-CMAKE-SCRIPTS
