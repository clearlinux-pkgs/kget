...
Version  : 22.12.1
Release  : 51
URL      : https://download.kde.org/stable/release-service/22.12.1/src/kget-22.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/kget-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/kget-22.12.1.tar.xz.sig
...
%prep
%setup -q -n kget-22.12.1
cd %{_builddir}/kget-22.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673310707
mkdir -p clr-build
pushd clr-build
