...
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/kget-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/kget-22.12.3.tar.xz.sig
...
%prep
%setup -q -n kget-22.12.3
cd %{_builddir}/kget-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677796750
mkdir -p clr-build
pushd clr-build
