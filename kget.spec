...
Version  : 21.12.0
Release  : 36
URL      : https://download.kde.org/stable/release-service/21.12.0/src/kget-21.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/kget-21.12.0.tar.xz
...
%prep
%setup -q -n kget-21.12.0
cd %{_builddir}/kget-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639678469
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kget-21.12.0/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/kget/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/kget-21.12.0/COPYING %{buildroot}/usr/share/package-licenses/kget/3860f7708aae6a8ddfe8483263b2a5f29b83c975
cp %{_builddir}/kget-21.12.0/COPYING.DOC %{buildroot}/usr/share/package-licenses/kget/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
cp %{_builddir}/kget-21.12.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kget/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/kget-21.12.0/cmake/modules/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/kget/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build
%make_install
popd
%find_lang kget
